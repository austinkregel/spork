...
if (Feature::active(\App\Features\Automatic\GeneratedPages::class)) {
    if (file_exists(base_path('routes/generate-pages.php'))) {
        include_once base_path('routes/generate-pages.php');
    }
}

if (Feature::active(\App\Features\Automatic\ServerLinking::class)) {
...
if (Feature::active(\App\Features\Automatic\Crud::class)) {
    Route::prefix('api')
...
if (Feature::active(\App\Features\Domains::class)) {
    Route::domain(
