...
<div class="relative flex items-top justify-center min-h-screen bg-stone-100 dark:bg-stone-900 sm:items-center sm:pt-0">
    <main>
        <nav class="flex ml-8 mb-5 pt-4 md:pt-0" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-4">
                <li>
                    <div>
                        <a href="https://forge.laravel.com/servers" target="_blank" class="text-stone-400 hover:text-stone-500">
                ...
                <li>
                    <div class="flex items-center">
                        <svg class="flex-shrink-0 h-5 w-5 text-stone-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                        </svg>
                        <a href="http://{{$page['domain']}}" target="_blank" aria-current="page" class="ml-4 text-sm font-medium text-stone-500 hover:text-stone-700">{{$page['domain']}}</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="px-6 sm:px-2 bg-white border-b border-stone-200">
                        <div>
                            <div class="max-w-7xl pt-6 pb-12 px-2 sm:px-2 lg:px-6">
                                <div class="max-w-3xl ">
                                    <p class="mt-4 font-medium text-lg text-stone-800">We've finished preparing your site for you. Here are the next steps:</p>
                                </div>
                                ...
                                <dl class="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-3 lg:gap-x-8">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <dt class="text-lg leading-6 font-medium text-stone-900">
