    ...
    <div class="w-full min-h-full flex bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-200 relative">
        ...
        <div class="absolute top-0 z-20 mt-14 left-0" :class="!$store.getters.hidingRootNav ? 'ml-12 2xl:ml-[15.25rem]' : '-ml-2'">
            ...
            class="rounded-full bg-white dark:bg-slate-900 border-2 border-slate-50 dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
                ...
                <ChevronLeftIcon v-else class="text-gray-200 dark:text-gray-400 h-6 w-6" />
            </button>
        </div>
        ...
        <div class="w-14 2xl:w-64 flex flex-col justify-between" :class="$store.getters.hidingRootNav ? '-ml-14 2xl:-ml-64' : ''">
            ...
            <div class="flex w-full flex flex-col-reverse 2xl:flex-row lg:gap-4 md:justify-between items-center p-4 text-gray-100">
                ...
                <div class="flex flex-col items-center">
                    <Popover class="relative h-8 mt-2">
                        <PopoverButton>
                            <BellIcon class="w-6 h-6 text-slate-800 dark:text-slate-300 fill-current"></BellIcon>
                        ...
                        <PopoverPanel class="absolute z-10 rounded shadow bg-white dark:bg-slate-600 p-2 bottom-0 mb-8 left-0" style="width: 20rem; height:30rem;">
                            <div class="flex justify-between border-b border-slate-500 dark:border-slate-700 pb-1 mb-1">
                            ...
                            <div class="grid grid-cols-1">
                                ...
                                <div v-else>
                                    <div class="text-center italic text-gray-500 dark:text-gray-200">You're all caught up!</div>
                                </div>
                            </div>
                        </PopoverPanel>
                    </Popover>
