<template>
    <div class="flex flex-wrap mt-4">
        <div class="w-full py-2 px-4 text-2xl font-bold text-gray-800 dark:text-gray-200">Banking Dashboard</div>
        <div class="w-full pb-8 px-4 text-base font-base text-gray-500 dark:text-gray-300">Welcome Back, {{$store.getters.user.name}}!</div>
        ...
        <div class="w-1/2" v-if="$store.getters.allAccountsFromFeatures">
            ...
            <div class="bg-white dark:bg-gray-600 shadow overflow-hidden sm:rounded-md m-4">
                <ul v-if="$store.getters.transactions.length > 0" role="list" class="divide-y divide-gray-200 h-96 overflow-y-scroll">
                ...
                <div v-else>
                    <div class="p-4">
                        <div class="text-sm italic text-gray-500 dark:text-gray-200">
        ...
        <div class="w-1/2" v-if="!$store.getters.features?.finance">
            ...
            <div class="bg-white dark:bg-gray-600 shadow overflow-hidden sm:rounded-md m-4 p-4">
