        ...
        <div class="w-full px-4">
            ...
            <div class="flex flex-wrap -mx-4" v-if="$store.getters.features?.servers?.length > 0">
                <div class="w-1/2" v-for="server in servers">
                    <div class="shadow rounded rounded-lg bg-white dark:bg-stone-700 leading-loose mx-4">
                        <div class="p-4">
                            ...
                            <div class="w-full flex justify-between border-t border-stone-300">
                        ...
                        <div class="w-full bg-stone-100 dark:bg-stone-600 p-4 flex justify-between">
                            <div class="flex flex-col leading-tight">
                                <router-link class="text-blue-500 font-semibold" :to="'/servers/' + server.id">More Information</router-link>
                                <div class="text-xs text-stone-600 dark:text-stone-300">{{ server.updated_at | date }}</div>
                            </div>
            ...
            <div v-else class="flex flex-wrap w-full">
                <div class="shadow rounded-lg bg-white dark:bg-stone-700 p-4 flex-1 italic">
