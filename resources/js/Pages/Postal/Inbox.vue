    ...
    <AppLayout title="Postal/Inbox">
        ...
        <main class="flex flex-wrap w-full h-full overflow-hidden justify text-white" style="max-height: calc(100vh - 65px);">
          ...
          <div class="w-1/2 xl:w-3/4 border-l border-stone-600 relative z-0" v-if="openMail">
            ...
            <iframe :src="route('postal.show',  [openMail?.id])" class="w-full  overflow-hidden" style="height: calc(100vh - 192px);" />
          </div>
          <div v-else class="my-12 flex flex-col w-1/2 xl:w-3/4 overflow-y-scroll border-l border-stone-600 justify-center items-center">
