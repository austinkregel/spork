    ...
    <AppLayout :title="title">
        <div class="w-full flex">
            ...
            <div v-else class="flex flex-wrap flex-grow pr-4">
                <div class="w-full py-4 z-50 flex gap-4 justify-end items-center" >
                    <div>{{ openFile.name }}</div>
                    <SporkButton small secondary @click="cancelFile" class="">cancel</SporkButton>
                    <SporkButton small primary @click="saveFile" class="">Save</SporkButton>
                </div>
                <CodeEditor
                    v-model="file"
                    theme="github-dark"
